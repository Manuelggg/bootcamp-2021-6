...
public class PagePaquetes extends SeleniumBaseE5 {
    ...
    public void Esperapagina2(){waitExplicitLocated(prueba,4);}
   ...
   // public void Validacion(){validacionText(prueba,"5 a 7 noches");}
    ...
    public void Validacion2(){validacionText(TextFebrero,"Marzo");}
    ...
    public void AplicarEdad(){
        clickear(BtnAplicarHusped);
    }
    public void ClickBuscar2(){clickear(BtnBuscar);}
    public void FiltrarAerolinea(){clickear(FiltroAerolinea);
